...
int main(int argc, const char *argv[])
{
    ...
    string imgPrefix = "KITTI/2011_09_26/image_00/data/000000"; // left 2d_features, color
    string imgFileType = ".png";
    int imgStartIndex = 0; // first file index to load (assumes Lidar and 2d_features names have identical naming convention)
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        cout << "#1 : LOAD IMAGE INTO BUFFER done: " + std::to_string(dataBuffer.size()) << endl;
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            // string descriptorType = "DES_HOG"; //Only for SIFT
            ...
            if (bVis)
            {
                ...
                string windowName = "Matching keypoints between two 2d_features images";
